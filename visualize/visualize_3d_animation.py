...
def visualize_3d_pose_animation(pose_filename, fps=30):
    """
    ...
    def update(frame_num):
        ...
        # Plot landmarks
        ax.scatter(xs, ys, zs, c='red', marker='o', s=100)
...
def main():
    ...
    output_dir = 'output'
    pose_files = glob.glob(os.path.join(output_dir, 'realtime_pose_3d_coordinate_20251016_160639.npy'))
    ...
    visualize_3d_pose_animation(latest_file, fps)
